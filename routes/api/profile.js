...
// READ FOR LATER -  READ FOR LATER -  READ FOR LATER -  READ FOR LATER -  READ FOR LATER -  READ FOR LATER -  READ FOR LATER
// Use in coursework for generating homepage
        ...
        Profile.findOne({
            ...
            if (profile) {
                ...
                Profile.findOne({
                    ...
                    if (profile) {
                        errors.ahndle = "That handle already exists";
